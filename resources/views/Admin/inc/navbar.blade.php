        ...
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn " aria-expanded="true" href="{{ route("change", "en") }}">English</a>
            </li>
            <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn " aria-expanded="true" href="{{ route("change", "ar") }}">العربية</a>
            </li>
            <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn " aria-expanded="true" href="{{ route("user") }}">User Area </a>
            </li>
